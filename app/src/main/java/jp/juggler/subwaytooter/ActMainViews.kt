...
class ActMainViews(
    ...
    val llQuickTootBar: LinearLayout,
    val btnQuickTootMenu: ImageButton,
    val etQuickToot: MyEditText,
    val ivQuickTootAccount: MyNetworkImageView,
    val btnQuickToot: ImageButton,
