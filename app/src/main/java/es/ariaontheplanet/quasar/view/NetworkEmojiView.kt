package es.ariaontheplanet.quasar.view
...
import es.ariaontheplanet.quasar.util.EmojiImageRect
...
//        },
    ...
    private fun drawError(canvas: Canvas) {
        ...
        try {
            ...
            //			at es.ariaontheplanet.quasar.span.NetworkEmojiSpan.draw (NetworkEmojiSpan.kt:137)
        } finally {
            canvas.restore()
        }
    }
