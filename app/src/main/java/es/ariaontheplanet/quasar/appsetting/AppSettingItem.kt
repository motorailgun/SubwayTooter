...
import es.ariaontheplanet.quasar.ActExitReasons

import es.ariaontheplanet.quasar.App1
import es.ariaontheplanet.quasar.R
import es.ariaontheplanet.quasar.actmain.selectPushDistributor
import es.ariaontheplanet.quasar.dialog.runInProgress
import es.ariaontheplanet.quasar.pref.AdditionalButtonsPosition
import es.ariaontheplanet.quasar.notification.showAlertNotification
...
import es.ariaontheplanet.quasar.pref.impl.BasePref
...
import es.ariaontheplanet.quasar.pref.impl.LongPref
...
import es.ariaontheplanet.quasar.util.reNotAllowedInUserAgent
import es.ariaontheplanet.quasar.util.userAgentDefault
