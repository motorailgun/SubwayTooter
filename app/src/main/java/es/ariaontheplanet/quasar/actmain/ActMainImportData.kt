...
import es.ariaontheplanet.quasar.appsetting.AppDataExporter
import es.ariaontheplanet.quasar.column.Column
import es.ariaontheplanet.quasar.notification.setImportProtector
    ...
    launchProgress(
        ...
        afterProc = {
            ...
            try {
                ...
                // Note: The list clearing and adding is done here
