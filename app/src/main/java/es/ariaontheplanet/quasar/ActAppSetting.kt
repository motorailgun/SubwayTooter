...
import es.ariaontheplanet.quasar.appsetting.AppSettingItem
import es.ariaontheplanet.quasar.appsetting.AppSettingScreen
import es.ariaontheplanet.quasar.appsetting.AppSettingViewModel
import es.ariaontheplanet.quasar.appsetting.SettingType
import es.ariaontheplanet.quasar.appsetting.appSettingRoot
import es.ariaontheplanet.quasar.compose.ColorPickerDialog
import es.ariaontheplanet.quasar.dialog.DlgAppPicker
import es.ariaontheplanet.quasar.notification.restartAllWorker
    ...
    private fun encodeAppData(): File {
        ...
        ZipOutputStream(FileOutputStream(file)).use { zipStream ->
            ...
            try {
                ...
                es.ariaontheplanet.quasar.appsetting.AppDataExporter.encodeAppData(activity, jw)
                jw.flush()
            } finally {
            ...
            for (column in appState.columnList) {
                es.ariaontheplanet.quasar.appsetting.AppDataExporter.saveBackgroundImage(
                    activity,
                    zipStream,
                    column,
                )
