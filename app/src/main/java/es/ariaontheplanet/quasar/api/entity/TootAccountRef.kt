...
import es.ariaontheplanet.quasar.util.DecodeOptions.Companion.emojiScaleMastodon
import es.ariaontheplanet.quasar.util.DecodeOptions.Companion.emojiScaleMisskey
